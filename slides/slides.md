...
![w:850](./diagrams/decision-tree.svg)
...
![w:780](./diagrams/queue-pattern.svg)
...
| `max_batch_timeout` | 満杯未満でも配送される**待ち秒数** | 5 / 30 |
...
### ⚠️ Workers CPU 30秒上限との相性
- Worker で処理: `batch_size × 1件処理時間 < 25秒` に収める
- Container に委譲: batch は大きめでも CPU 上限の心配は不要
